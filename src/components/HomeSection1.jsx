...
export default function HomeSection1(){
    return(
        <div className="grid grid-col-1 md:grid-cols-3 xl:grid-cols-3 xl:gap-0 md:gap-5 w-11/12 mx-auto">
         <div className="mx-auto card card-compact bg-card shadow-2xl rounded-none border-card xl:w-96 md:w-72 w-80 xl:my-0 md:my-0 my-3">
        <figure>
            <img className='img'
            src={PrenotaTavolo}
            alt="" />
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <button className="bg-red-600 hover:bg-red-700 button mx-auto my-3 text-white font-semibold"><a href="/prenota">PRENOTA IL TAVOLO</a></button>
                </div>
            </div>
        </div>
       ...
       <div className="mx-auto card card-compact bg-card shadow-2xl rounded-none border-card xl:w-96 md:w-72 w-80 xl:my-0 md:my-0 my-3">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <button className="bg-red-600 hover:bg-red-700 button mx-auto my-3 text-white font-semibold"><a href="/menù">PRENOTA IL TUO TAKE AWAY</a></button>
                </div>
            </div>
        </div>
        ...
        <div className="mx-auto card card-compact bg-card shadow-2xl rounded-none border-card xl:w-96 md:w-80 w-80 xl:my-0 md:my-0 my-3">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <button className="bg-red-600 hover:bg-red-700 button mx-auto my-3 text-white font-semibold"><a href="/menù">ORDINA IL TUO DELIVERY</a></button>
                </div>
            </div>
        </div>
        </div>
